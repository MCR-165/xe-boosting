  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          background: `radial-gradient(600px at ${mousePos.x}px ${mousePos.y}px, rgba(18, 130, 255, 0.15), transparent 80%)`
        }}
      />

      {/* 2. Subtle Scanline Overlay */}
      ...
      {/* 3. Hero Content Wrapper (Z-10 to stay on top) */}
      <div className="relative z-10 px-6 max-w-5xl flex flex-col items-center">
        
        {/* Animated Badge */}
        <div className="mb-6 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#1282FF]/10 border border-[#1282FF]/30 animate-pulse">
        ...
        {/* Main Title */}
        <h1 className="font-montserrat font-bold text-5xl md:text-8xl leading-none tracking-tighter text-white">
        ...
        {/* Sub-headline */}
        <p className="font-rajdhani text-blue-100/60 text-xl md:text-2xl max-w-2xl mt-6 mb-10 leading-relaxed tracking-wide">
