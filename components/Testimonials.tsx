...
//             <div 
//               key={index} 
//               className="group relative p-8 bg-blue-900/10 border border-blue-500/10 rounded-3xl backdrop-blur-md transition-all duration-500 hover:border-[#1282FF]/40 hover:-translate-y-2 flex flex-col"
//             >
//               {/* Verified Badge */}
...
//               {/* User Info - Added mt-auto to push to bottom */}
...
//               {/* Adjusted Date Position to avoid collision */}
//               <span className="absolute bottom-4 right-6 font-rajdhani text-[10px] text-white/10 uppercase tracking-[0.2em]">
//                 {rev.date}
//               </span>
//             </div>
//           ))}
